...
export default function Hero() {
  return (
    <main class={tw`lg:relative`}>
      <div class={tw`mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left`}>
        <div class={tw`px-4 lg:w-1/2 sm:px-8 xl:pr-16`}>
          <h1 class={tw`text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl`}>
            <span class={tw`block xl:inline`}>Meu Santinho</span>{" "}
          </h1>
          <p class={tw`mt-3 max-w-md mx-auto text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl`}>
            Escolha seus candidatos a partir da sua unidedade federativa e compartilhe a imagem do santinho no instagram!
          </p>
      ...
      <div class={tw`relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full`}>
        <img
