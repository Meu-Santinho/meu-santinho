const navigation = {
  ...
  social: [
    {
      name: "GitHub",
      href: "https://github.com/Meu-Santinho/meu-santinho",
      icon: (props: any) => (
...
export default function Footer() {
  return (
    <footer class="bg-gray mt-12 py-4">
      <div class={`flex items-center justify-center flex-col`}>
        <div class="bg-white rounded flex justify-center items-center p-2 mb-8">
          <img src="logo.png" width="250" class="rounded"></img>
        </div>
        <div>
          <div class="flex">
        ...
        <div class="flex items-center ">
          {navigation.usuarios.map((user) => (
            <a
              href={user.href}
              target="_blank"
              class="flex text-white ml-2 items-center  text-white font-light text-white my-2"
            >
              {`${user.id}`}
            </a>
          ))}
